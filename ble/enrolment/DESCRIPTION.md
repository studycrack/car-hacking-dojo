...
*  Martin Herfurt showed in June 2022 that on Tesla vehicles the authorisation that window granted was too general. It also covered **enrolling an entirely new key**, with no further authentication and nothing on the display to say a key had been added. Anyone in Bluetooth range while the owner used their card could leave themselves a key.
