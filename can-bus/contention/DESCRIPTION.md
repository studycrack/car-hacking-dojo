...
*  So the work is not to defeat the key check. It is to report the result of one yourself.
...
*  Report it faster than the controller reporting otherwise, and do not stop.
